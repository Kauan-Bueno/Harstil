    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse text-center" id="navbar">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="cadastrobarbearia.php">Cadastrar um negócio</a>
          </li>
          <li class="nav-item">
...
<div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <h7 class="feedback">O que é o Harstil e quais são seus diferenciais?</h7>
        <p class="mb-100 color-text">Conheça os motivos para conhecer e utilizar o Harstil.</p>
    <div class="container">
         <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card p-4 border-blue">
                    <h5><i class="ti-layers-alt round-icon blue mr-2"></i> Experiência</h5>
                    <p class="mb-0 color-text">Conectamos você ao seu estilo! Agende seu corte e sinta a diferença de um atendimento personalizado.</p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card p-4 border-blue">
                    <h5><i class="ti-desktop round-icon green mr-2"></i> Exclusividade</h5>
                    <p class="mb-0 color-text">Transformamos o agendamento em um ato de cuidado. Cada cliente merece atenção e um tempo reservado! </p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card p-4 border-blue">
                    <h5><i class="ti-panel round-icon orange mr-2"></i> Valorização</h5>
                    <p class="mb-0 color-text">Facilitamos sua experiência na barbearia, garantindo que cada visita seja especial e sem complicações!</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-10 mx-auto">
      <div class="team-slider">
        ...
        <div class="team-member">
          ...
          <p class="color-text">O site funciona bem e cumpre com as expectativas.</p>
        </div>
        <!-- team-member -->
        <div class="team-member">
          <div class="d-flex mb-4">
          ...
          <p class="color-text">Com o site, consegui conhecer barbearias próximas.</p>
        </div>
        <!-- team-member -->
        <div class="team-member">
          <div class="d-flex mb-4">
          ...
          <p class="color-text">Esse site me ajudou bastante, pude conhecer bons serviços na região.</p>
        </div>
        ...
        <div class="team-member">
          ...
          <p class="color-text">Finalmente descobri bons lugares para cortar o cabelo, graças a esse site que conheci!</p>
        </div>
        <!-- team-member -->
        <div class="team-member">
          <div class="d-flex mb-4">
          ...
          <p class="color-text">O site é intuitivo e cumpre o objetivo de ligar o cliente ao barbeiro.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <p class="mb-50 color-text">Planos de assinatura do nosso site.</p>
      </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            <div class="rounded text-center pricing-table table-1">
              ...
              <a href="https://buy.stripe.com/test_dR6dTme7wbVq4RafYZ" class="btn pricing-btn px-2">Assinar</a>
            </div>
          </div>
          <!-- pricing table -->
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            <div class="rounded text-center pricing-table table-2">
              ...
              <a href="https://buy.stripe.com/test_4gw5mQ3sS6B60AU4gj" class="btn pricing-btn px-2">Assinar</a>
            </div>
          </div>
          <!-- pricing table -->
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            <div class="rounded text-center pricing-table table-3">
              ...
              <a href="https://buy.stripe.com/test_7sIbLed3sgbG2J29AC" class="btn pricing-btn px-2">Assinar</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <nav class="col-lg-8 align-self-center mb-5">
        <ul class="list-inline text-lg-right text-center footer-menu">
          ...
          <li class="list-inline-item"><a class="page-scroll" href="#feature">Team</a></li>
          <li class="list-inline-item"><a href="about.html">Pricing</a></li>
          <li class="list-inline-item"><a class="page-scroll" href="#team">Contact</a></li>
          <li class="list-inline-item"><a class="cadastro.php" href="#pricing">Cadastro</a></li>
          <li class="list-inline-item"><a href="service.php">Login</a></li>
        </ul>
      </nav>
      <!-- footer social icon -->
      <nav class="col-12">
